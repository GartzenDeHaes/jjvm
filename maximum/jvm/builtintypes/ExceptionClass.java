...
public class ExceptionClass implements ClassDef
{
	...
	public ExceptionClass ( ThrowableClass sup, HeapManager heap )
	{
		this.heap = heap;
		superClass = sup;
	}
	...
	public ClassInstance createClassInstance ( int refId, HeapManager heap )
	{
		...
		{
			te.printStackTrace();
			ASSERT.fatal ( false, "ArrayInstance", 88, "Internal Error" );
		}
		return null;
	}
	...
	{
		ReferenceType rt = new ExceptionInstance ( heap, refId, ci );
		return rt;
	}
}
